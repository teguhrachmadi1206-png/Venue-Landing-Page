...
export default function ClassBanner({ media, program, page }) {
    ...
    return (
        <div className={`class-banner ${page}`}>
            ...
            <img className={`class-poster ${page} ${isPastWorkshop ? "past" : ""}`} src={program.imgSrc} alt={program.imgAlt} onClick={page === "detail" && showPoster} />
            <div className={`class-info ${page}`}>
                ...
                <div className={`class-info-content ${page}`}>
                    ...
                    {program.type === "regular" && <div className={`class-info-row ${page}`}>
                    ...
                    {media !== 1 && <div className={`class-info-row ${page}`}>
