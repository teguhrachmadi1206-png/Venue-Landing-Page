...
export default function Events({ media }) {
    ...
    const listStartRef2 = useRef(null)
                ...
                <section className="main-event-page">
                    ...
                    <div className="event-page-card-container">
                        {displayEventCards.length > 0
                            ? displayEventCards.map(event => <EventCardComp key={event.id} event={event} pages="events-page" variant={new Date(event.dateTime) < new Date ? "past" : "upcoming"} />)
